...
你知道上班有多无聊的。尤其是公司连个有用的业务SaaS都不给你买，还要你像个原始人一样去运算，而每次让AI计算都要说明复杂的数学逻辑，浪费人生说的就是这样的事情。当然，能做好数字化转型的企业是存在的，可是他们中的大多数管理策略方面对于目前业务的操作方面的痛点和销售策略上均存在思维方式老旧的问题。
对于新的技术和业务类型不敏感，决策层不理解B2B业务本身的复杂性该如何被新的技术消解，而是过度依赖于人工的判断导致工作量总是在指数级上升。对个人工作的压力和痛点被解决后可以如何反馈到效益上也没有概念。当大多数你的工作时间都用于可以被大幅度优化的认知负担时，你很难对你的工作抱有任何成就感。你不再有时间去思考该如何优化这个流程（在我的场合并不会这样，但是就我个人观察到的场合就是如此），而是选择拥抱它，或者被它吞噬。好了不抱怨了，我做这个只是单纯因为我能做，我认识的人想用这个题材自己做个项目，我在教学他prompt engineering的时候自己玩上瘾了，于是就有了这个作品。到V1.1.0为止总耗时三天。不过我遇到了非常恶心的Edge case，以及一些物理碰撞的问题不过，我自己用下来感觉良好。所以，你都看我说了这么多废话了，用用看？
...
## 支持 (Support)
如果你觉得 Forklift Desire确实帮到了你，让你无聊的工作变得有趣了一点，可以给我买杯咖啡。
