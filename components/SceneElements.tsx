...
export const HUMAN_THRESHOLD_WEIGHT = 30; 
export const FLOOR_HEIGHT = 0.16; 
export const ANIMATION_DURATION = 2.0; 
export const ANIMATION_GAP = 0.2;
export const LIFT_BUFFER = 0.1; 
export const FORKLIFT_LIFT_MARGIN_CM = 15;

export const FORKLIFT_DIMS = {
    chassisLength: 2.2,
    chassisWidth: 1.1,
    chassisHeight: 1.4,
    forkLength: 1.1, 
...
export const Forklift: React.FC<{ liftHeight: number; sideShift: number; boxWidth: number; boxLength: number }> = ({ liftHeight, sideShift, boxWidth, boxLength }) => {
...
export const Box: React.FC<BoxProps> = ({ item, delay, containerLength, containerWidth, animationDuration, offset, skipAnimation, isSelected, isDragging }) => {
  ...
  useFrame((state) => {
    ...
    const loadDuration = animationDuration * 0.9; 
